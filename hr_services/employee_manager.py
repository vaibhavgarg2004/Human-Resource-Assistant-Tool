...
if __name__ == "__main__":
    em = EmployeeManager()
    em.add_employee(EmployeeCreate(emp_id=em.get_next_emp_id(), name="Aarav Patel", manager_id=None))
    em.add_employee(EmployeeCreate(emp_id=em.get_next_emp_id(), name="Riya Kapoor", manager_id="E001"))
